...
![path dark](../../assets/ai-foundations/path-dark.webp)


1. Two different paths to take, deterministic vs probabilistic
2. The first piece of your AI mental model is to never assume you are guaranteed to get the same answer every time.
...
1. Even the same model and prompt can give a different response to the same question
2. Models sometimes don’t always follow your instructions.
...
![path dark](../../assets/ai-foundations/models-dark.webp)
