...
The AI model receives your request and recognizes it needs additional capabilities
It formats a special response in JSON (a structured data format) that specifies which tool to use and what parameters to pass
The application runs that tool and returns the results
The AI model incorporates those results into its context and continues the conversation
